...
//  URL=> http://aroraamu111.imad.hasura-app.io/articles/article-two";
//  pool.query("SELECT * FROM article WHERE title = '" + req.params.articleName + "'", function (err,result) {
//
//  Hacker's Query=> SELECT * FROM article WHERE title = ''; DELETE from article where a = 'a';
//  Hacker's URL=> http://aroraamu111.imad.hasura-app.io/articles/'; DELETE from "article" where 'a'='a
//
//  Smart Query=> SELECT * FROM article WHERE title = '\';DELETE from "article" aWHERE a = \'asdf'
//  URL: 
